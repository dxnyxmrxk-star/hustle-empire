...
(() => {
  ...
  */
  ...
  const { validateSavedState, migrateSavedSnapshot, parseSavedState } = window.HustleSaveSchema.create({
    defaultState: DEFAULT_STATE,
    clone,
    readPersistedCharacterGender,
    defaultGender: DEFAULT_CHARACTER_GENDER,
  ...
  */
  ...
  async function readTelegramCloudSnapshot() {
    ...
    try {
      ...
      console.warn("[Hustle Empire] Cloud restore unavailable; keeping local save:", error);
      return null;
    }
  }
